...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.newspaperdirect.example.samplesdk.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.newspaperdirect.example.samplesdk.GlideOptions().apply(toSet));
    }
  }
}
